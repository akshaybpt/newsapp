...
export class NewsItem extends Component {
  ...
  render() {
    let { tittle, description, imgUrl, newsUrl, author, publish, mode } = this.props;
    return (
      <>
        <div className="card  ">
          ...
          <div className={`card-body text-center bg-${mode}`}>
            ...
            <h6 className={`card-subtitle mb-2 text-${mode === 'light' ? 'muted' : 'white-50'} `} >Author: {!author ? "NewsApp" : author}</h6>
