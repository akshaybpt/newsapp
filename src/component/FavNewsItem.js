...
<div className="card  ">
          ...
          <div className="card-body text-center ">
            ...
            <h6 className="card-subtitle mb-2 text-muted" >Author: {!news.author ? news.source : news.author}</h6>
            ...
            <a rel="noreferrer" href={news.newsUrl} target="_blank" className="btn btn-primary">Read More</a>
